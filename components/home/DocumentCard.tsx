...
const DocumentCard: React.FC<DocumentCardProps> = ({ doc, handleDocumentClick, handleEditClick, handleDeleteClick }) => {
  return (
    <div 
      className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md border border-gray-200 mx-auto mb-12 cursor-pointer overflow-hidden group transform transition-transform duration-300 hover:scale-105 w-10/12 sm:w-9/12 md:w-8/12 lg:w-8/12 xl:w-13vw"
      style={{ height: "20vw" }}
